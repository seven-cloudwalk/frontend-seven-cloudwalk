...
export const LoadingComponent = () => {
  return (
    <S.LoadingContainer>
      <S.LoadingCard>
        <S.LoadingHeading>
          <S.LoadingH1Component className="loading-modal--heading">
            Buscando informações...
          </S.LoadingH1Component>
        </S.LoadingHeading>
        ...
        <S.LoadingFooter className="loading-modal-footer--container">
          <S.FooterLoadingComponent className="loading-modal--footer">
            Por favor aguarde{" "}
          </S.FooterLoadingComponent>
        </S.LoadingFooter>
      </S.LoadingCard>
    </S.LoadingContainer>
  );
